...
## Open item
Confirm with the photographer whether the cycling/sports work should be
framed as its own explicit "Sports & Events" portfolio category (given how
much of the current sample set is cycling) or folded into general Events
as outlined above. Current plan keeps it inside Events since pricing
doesn't have a separate sports-event tier.
